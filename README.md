...
```bash
kas shell ./freedom-u-sdk/scripts/kas/qemuriscv64.yml -c "runqemu snapshot slirp nographic tmp/deploy/images/qemuriscv64/demo-coreip-cli-qemuriscv64.rootfs.qemuboot.conf"
kas shell ./freedom-u-sdk/scripts/kas/qemuriscv64.yml -c "runqemu snapshot slirp serialstdio tmp/deploy/images/qemuriscv64/demo-coreip-xfce4-qemuriscv64.rootfs.qemuboot.conf"
```
